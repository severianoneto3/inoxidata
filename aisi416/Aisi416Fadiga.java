	...
	public Aisi416Fadiga() {
		...
		table.setModel(new DefaultTableModel(
			new Object[][] {
				...
				{"758", "-", "Temperado a 650ºC", "10^6 - 10^8", "Ar", "Ambiente", "https://www.asminternational.org/asm-handbook-volume-19-fatigue-and-fracture/results/-/journal_content/56/25656855/PUBLICATION/"},
				{"1241", "-", "Temperado a 315ºC", "10^6 - 10^8", "Ar", "Ambiente", "https://www.asminternational.org/asm-handbook-volume-19-fatigue-and-fracture/results/-/journal_content/56/25656855/PUBLICATION/"},
			},
			new String[] {
				"Limite (MPa)", "Frequ\u00EAncia (Hz)", "Condição", "Num. de ciclos", "Meio", "Temperatura", "Fonte"
			}
		) {
