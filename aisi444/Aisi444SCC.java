...
public class Aisi444SCC extends JFrame {
	...
	public Aisi444SCC() {
		...
		JLabel lblAisi444SCC = new JLabel("AISI 444 - Corros\u00E3o Sob Tens\u00E3o");
		lblAisi444SCC.setBounds(205, 10, 375, 46);
		lblAisi444SCC.setFont(new Font("Rockwell", Font.BOLD, 25));
		contentPane.add(lblAisi444SCC);
