...
public class Aisi436SCC extends JFrame {
	...
	public Aisi436SCC() {
		...
		JLabel lblAisi436SCC = new JLabel("AISI 436 - Corros\u00E3o Sob Tens\u00E3o");
		lblAisi436SCC.setBounds(205, 10, 375, 46);
		lblAisi436SCC.setFont(new Font("Rockwell", Font.BOLD, 25));
		contentPane.add(lblAisi436SCC);
