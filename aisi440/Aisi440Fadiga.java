...
public class Aisi440Fadiga extends JFrame {
	...
	public Aisi440Fadiga() {
		...
		JLabel lblAisi440Fadiga = new JLabel("AISI 440 - Fadiga");
		lblAisi440Fadiga.setBounds(291, 10, 204, 46);
		lblAisi440Fadiga.setFont(new Font("Rockwell", Font.BOLD, 25));
		contentPane.add(lblAisi440Fadiga);
		...
		table.setModel(new DefaultTableModel(
			new Object[][] {
				{"~ 750", "-", "-1", "10^5", "Ar", "Ambiente", "https://www.aseestant.ceon.rs/index.php/jmm/article/view/11431"},
				{"~ 700", "-", "-1", "2 * 10^5", "Ar", "Ambiente", "https://www.aseestant.ceon.rs/index.php/jmm/article/view/11431"},
				{"~ 650", "-", "-1", "10^6", "Ar", "Ambiente", "https://www.aseestant.ceon.rs/index.php/jmm/article/view/11431"},
				{"~ 600", "-", "-1", "3 * 10^6", "Ar", "Ambiente", "https://www.aseestant.ceon.rs/index.php/jmm/article/view/11431"},
				{"~ 550", "-", "-1", "2 * 10^7", "Ar", "Ambiente", "https://www.aseestant.ceon.rs/index.php/jmm/article/view/11431"},
			},
			new String[] {
