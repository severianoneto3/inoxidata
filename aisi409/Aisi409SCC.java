...
public class Aisi409SCC extends JFrame {
	...
	public Aisi409SCC() {
		...
		JLabel lblAisi409SCC = new JLabel("AISI 409 - Corros\u00E3o Sob Tens\u00E3o");
		lblAisi409SCC.setBounds(205, 10, 375, 46);
		lblAisi409SCC.setFont(new Font("Rockwell", Font.BOLD, 25));
		contentPane.add(lblAisi409SCC);
