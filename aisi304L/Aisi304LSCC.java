...
public class Aisi304LSCC extends JFrame {
	...
	public Aisi304LSCC() {
		...
		JLabel lblAisi304LSCC = new JLabel("AISI 304L - Corros\u00E3o Sob Tens\u00E3o");
		lblAisi304LSCC.setBounds(197, 10, 391, 46);
		lblAisi304LSCC.setFont(new Font("Rockwell", Font.BOLD, 25));
		contentPane.add(lblAisi304LSCC);
