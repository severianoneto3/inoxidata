...
public class Aisi436Fadiga extends JFrame {
	...
	public Aisi436Fadiga() {
		...
		JLabel lblAisi436Fadiga = new JLabel("AISI 436 - Fadiga");
		lblAisi436Fadiga.setBounds(291, 10, 204, 46);
		lblAisi436Fadiga.setFont(new Font("Rockwell", Font.BOLD, 25));
		contentPane.add(lblAisi436Fadiga);
