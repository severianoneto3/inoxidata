...
public class Aisi321Fadiga extends JFrame {
	...
	public Aisi321Fadiga() {
		...
		JLabel lblAisi321Fadiga = new JLabel("AISI 321 - Fadiga");
		lblAisi321Fadiga.setBounds(291, 10, 204, 46);
		lblAisi321Fadiga.setFont(new Font("Rockwell", Font.BOLD, 25));
		contentPane.add(lblAisi321Fadiga);

		JScrollPane scrollPane = new JScrollPane();
		scrollPane.setFont(new Font("Bahnschrift", Font.BOLD, 12));
		scrollPane.setBounds(32, 89, 721, 128);
		...
		table.setModel(new DefaultTableModel(
			new Object[][] {
				{"195", "0,003 Hz", "-", "2,4 * 10^4", "Ar", "Ambiente", "https://www.sciencedirect.com/science/article/pii/S0142112316302134"},
				{"217", "0,003 Hz", "-", "4,2 * 10^3", "Ar", "Ambiente", "https://www.sciencedirect.com/science/article/pii/S0142112316302134"},
				{"247", "0,003 Hz", "-", "1,7 * 10^3", "Ar", "Ambiente", "https://www.sciencedirect.com/science/article/pii/S0142112316302134"},
				{"290", "0,003 Hz", "-", "467", "Ar", "Ambiente", "https://www.sciencedirect.com/science/article/pii/S0142112316302134"},
			},
			new String[] {
