...
public class Aisi409Fadiga extends JFrame {
	...
	public Aisi409Fadiga() {
		...
		JLabel lblAisi409Fadiga = new JLabel("AISI 409 - Fadiga");
		lblAisi409Fadiga.setBounds(291, 10, 204, 46);
		lblAisi409Fadiga.setFont(new Font("Rockwell", Font.BOLD, 25));
		contentPane.add(lblAisi409Fadiga);
		...
		table.setModel(new DefaultTableModel(
			new Object[][] {
				{"~ 320", "15", "0,1", "2 * 10^5", "Ar", "Ambiente", "https://www.sciencedirect.com/science/article/pii/S0921509312001074?via%3Dihub"},
				{"~ 280", "15", "0,1", "5,5 * 10^5", "Ar", "Ambiente", "https://www.sciencedirect.com/science/article/pii/S0921509312001074?via%3Dihub"},
				{"~ 230", "15", "0,1", "1,2 * 10^6", "Ar", "Ambiente", "https://www.sciencedirect.com/science/article/pii/S0921509312001074?via%3Dihub"},
				{"~ 175", "15", "0,1", "2,8 * 10^6", "Ar", "Ambiente", "https://www.sciencedirect.com/science/article/pii/S0921509312001074?via%3Dihub"},
				{"~ 130", "15", "0,1", "4,5 * 10^6", "Ar", "Ambiente", "https://www.sciencedirect.com/science/article/pii/S0921509312001074?via%3Dihub"},
			},
			new String[] {
				"Tensão (MPa)", "Frequ\u00EAncia (Hz)", "Raz\u00E3o de fadiga", "Num. de ciclos", "Meio", "Temperatura", "Fonte"
			}
		) {
