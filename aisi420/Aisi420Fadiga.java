...
public class Aisi420Fadiga extends JFrame {
	...
	public Aisi420Fadiga() {
		...
		JLabel lblAisi420Fadiga = new JLabel("AISI 420 - Fadiga");
		lblAisi420Fadiga.setBounds(291, 10, 204, 46);
		lblAisi420Fadiga.setFont(new Font("Rockwell", Font.BOLD, 25));
		contentPane.add(lblAisi420Fadiga);
		...
		table.setModel(new DefaultTableModel(
			new Object[][] {
				{"~ 700", "1,4", "-", "6 * 10^3", "Ar", "Ambiente", "https://www.thaiscience.info/Journals/Article/SONG/10993198.pdf"},
				{"~ 650", "1,4", "-", "1,2 * 10^4", "Ar", "Ambiente", "https://www.thaiscience.info/Journals/Article/SONG/10993198.pdf"},
				{"~ 550", "1,4", "-", "4,5 * 10^4", "Ar", "Ambiente", "https://www.thaiscience.info/Journals/Article/SONG/10993198.pdf"},
				{"~ 500", "1,4", "-", "1,3 * 10^5", "Ar", "Ambiente", "https://www.thaiscience.info/Journals/Article/SONG/10993198.pdf"},
				{"~ 450", "1,4", "-", "1,5 * 10^6", "Ar", "Ambiente", "https://www.thaiscience.info/Journals/Article/SONG/10993198.pdf"},
				{"~ 400", "1,4", "-", "1,5 * 10^7", "Ar", "Ambiente", "https://www.thaiscience.info/Journals/Article/SONG/10993198.pdf"},
			},
			new String[] {
