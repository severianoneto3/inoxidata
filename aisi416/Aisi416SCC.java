...
public class Aisi416SCC extends JFrame {
	...
	public Aisi416SCC() {
		...
		JLabel lblAisi416SCC = new JLabel("AISI 416 - Corros\u00E3o Sob Tens\u00E3o");
		lblAisi416SCC.setBounds(205, 10, 375, 46);
		lblAisi416SCC.setFont(new Font("Rockwell", Font.BOLD, 25));
		contentPane.add(lblAisi416SCC);
